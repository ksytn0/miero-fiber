...
$(document).ready(function(){
    ...
    */
    ...
    /*
    let tab_mnu1 = $('.tab_con_wrap > li:first-child > a');
    let tab_mnu2 = $('.tab_con_wrap > li:nth-child(2) > a');
    let tab_mnu3 = $('.tab_con_wrap > li:last-child > a');
    */
    $('.tab_con_wrap > li:first-child > div').show(); //솔까 이해안감 이 코드
...
*/
    ...
    /*
    //n번째 탭메뉴 높이조절
    tab_mnu1.click(function(){
        $('.tab_con article').css('height','695px');
    });
    tab_mnu2.click(function(){
        $('.tab_con article').css('height','695px');
    });
    tab_mnu3.click(function(){
        $('.tab_con article').css('height','1160px');
    });
    */
